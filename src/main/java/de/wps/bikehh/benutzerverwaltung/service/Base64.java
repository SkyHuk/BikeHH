	...
	public static void main(String[] args) {
		try {
			...
			// Test Input Stream
			{
				...
				try (java.io.FileOutputStream fos = new java.io.FileOutputStream("test.gif_out")) {
					fos.write(bytes);
					fos.close();
				}
				...
				try (java.io.FileOutputStream fos = new java.io.FileOutputStream("test.gif.b64_out")) {
					fos.write(ebytes);
				}
