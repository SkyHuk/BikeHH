...
public class AuthenticationController {
	...
	@PostMapping("/check")
	@ResponseBody
	public ResponseEntity<HttpStatus> verifyToken(@RequestBody AuthTokenDto tokenDto) {
		return authService.hasSession(tokenDto.getToken()) ? new ResponseEntity<>(HttpStatus.OK)
